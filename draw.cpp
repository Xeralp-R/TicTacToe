...
RobotLossScreen::RobotLossScreen(QWidget *parent) : QWidget(parent){
    // copied directly from ganddrawscreen
    setMinimumSize(600, 450);
    setWindowTitle("Loss");
    ...
    // the title
    titlebox = new QLabel("Err...");
    titlebox->setAlignment(Qt::AlignCenter);
    titlebox->setMaximumHeight(title_text_max_height);
    titlebox->setObjectName("title");
    
    // also the title
    alsotitlebox = new QLabel("Sorry!");
    alsotitlebox->setAlignment(Qt::AlignCenter);
    alsotitlebox->setMaximumHeight(title_text_max_height);
    alsotitlebox->setObjectName("titleb");
    ...
    // the text itself
    textbox = new QLabel();
    textbox->setText("It looks like you weren't able to win against the robot.\n"
                     "Better luck next time!\n\n"
                     "Feel free to play again— \n"
                     "you may still be able to defeat the robot!");
    textbox->setAlignment(Qt::AlignCenter);
    textbox->setObjectName("paragraph");
